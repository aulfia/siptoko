...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Toko Sembako</a>
            <!-- Sidebar Toggle-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Selamat Datang di Sistem Penjualan Toko Sembako Rena</li>
                        </ol>
                        <div class="row">
                        ...
                        <a href="export.php" class="btn btn-secondary mb-4">Export Data</a>
