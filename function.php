...
//bikin koneksi
$conn = mysqli_connect('localhost', 'root', '', 'sistempenjualanbisa');
...
if(isset($_POST['tambahbarang'])){
    ...
    $insert = mysqli_query($conn, "insert into produk (namaproduk,deskripsi,harga,stock) values ('$namaproduk',
...
if(isset($_POST['tambahpelanggan'])){
    ...
    $insert = mysqli_query($conn, "insert into pelanggan (namapelanggan,notelp,alamat) values ('$namapelanggan',
    '$notelp','$alamat')");
